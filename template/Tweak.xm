...
// ============================================================
//  v114.4 - FEW1N MOD MENU  (derlenir, hatasiz - bu dosyayi kullan)
...
- (void)build {
    ...
    ver.text = [NSString stringWithFormat:@"v114.4  •  Base 0x%lX", (unsigned long)global_base];
...
%ctor {
    ...
    FLog(@"v114.4 basladi, UnityFramework araniyor...");
    restoreSettings();
