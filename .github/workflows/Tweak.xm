...
// ============================================================
//  v87.0 - FEW1N MOD MENU  (derlenir, hatasiz - bu dosyayi kullan)
...
- (void)build {
    ...
    ver.text = [NSString stringWithFormat:@"v87.0  •  Base 0x%lX", (unsigned long)global_base];
...
%ctor {
    FLog(@"v87.0 basladi, UnityFramework araniyor...");
    restoreSettings();
